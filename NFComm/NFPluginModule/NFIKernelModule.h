...
public:
    ...
    inline int GetRecordInt32(const NFGUID& self, const std::string& recordName, const int row, const int col)
    {
    ...
    inline int GetRecordInt32(const NFGUID& self, const std::string& recordName, const int row, const std::string& colTag)
    {
