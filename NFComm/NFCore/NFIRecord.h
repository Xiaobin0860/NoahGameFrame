...
public:
    ...
    virtual int GetInt32(const int row, const int col) const
    {
        return (int)GetInt(row, col);
    };
    ...
    inline int GetInt32(const int row, const std::string& colTag) const
    {
        return (int)GetInt(row, colTag);
    };
